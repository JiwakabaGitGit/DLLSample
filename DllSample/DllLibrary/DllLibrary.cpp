// DllLibrary.cpp : DLL の初期化ルーチンを定義します。
//
...
BEGIN_MESSAGE_MAP(CDllLibraryApp, CWinApp)
END_MESSAGE_MAP()


// CDllLibraryApp の構築

CDllLibraryApp::CDllLibraryApp()
{
...
// 唯一の CDllLibraryApp オブジェクト

CDllLibraryApp theApp;


// CDllLibraryApp の初期化

BOOL CDllLibraryApp::InitInstance()
{
